...
--  Mobile + PC Compatible | "Like Bricks, Built Solid." ðŸ§±
...
local DefaultTheme = {
    ...
    TabWidth         = IsMobile and 80  or 110,
    TitleHeight      = 45,
    ToggleHeight     = IsMobile and 62  or 54,
    SliderHeight     = 66,
    ButtonHeight     = IsMobile and 44  or 38,
    WindowW          = IsMobile and 420 or 520,
    WindowH          = IsMobile and 480 or 400,
    Padding          = 8,
    TextSizeSM       = IsMobile and 9  or 10,
    TextSizeMD       = IsMobile and 11 or 12,
    TextSizeLG       = IsMobile and 13 or 14,
}
...
function KaolinLib:CreateWindow(config)
    ...
    MinBtn.MouseButton1Click:Connect(function()
        ...
        MinBtn.Text = minimised and "â–¢" or "â€”"
    end)
    ...
    -- â”€â”€ WINDOW OBJECT â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    local Window      = {}
    Window._theme     = T
    ...
    -- â”€â”€ NOTIFICATION SYSTEM â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    -- â”€â”€ CREATE TAB â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    --[[
        Usage:
        local Tab = Window:CreateTab("Movement", "ðŸƒ")
    ]]
    function Window:CreateTab(name, icon)
        ...
        ListLayout(page, 8)
        Padding(page, 10, 10, 0, 4)

        -- Tab button
        local icon_str = icon and (icon .. "\n") or ""
        local btn = MakeButton({
            Size             = UDim2.new(1,0,0,IsMobile and 46 or 38),
            BackgroundColor3 = T.Background,
            Text             = icon_str .. name,
        ...
        -- â”€â”€ TAB OBJECT â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        local Tab   = {}
        Tab._page   = page
        Tab._theme  = T
        Tab._order  = 0
        ...
        function Tab:CreateToggle(config)
            ...
            local function SetToggle(val, silent)
                enabled = val
                Tween(dot,  {Position = enabled and UDim2.new(1,-21,0.5,-9) or UDim2.new(0,3,0.5,-9)})
        ...
        -- â”€â”€ Slider â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        --[[
        ...
        function Tab:CreateButton(config)
            ...
            MakeLabel({
                ...
                Size           = UDim2.new(1,-16,0,20),
                Position       = UDim2.new(0,12,0.5,config.Desc and -14 or -10),
                TextColor3     = T.Accent,
                TextSize       = T.TextSizeLG,
                Font           = T.FontBold,
                TextXAlignment = Enum.TextXAlignment.Left,
        ...
        -- â”€â”€ TextBox â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        --[[
        ...
        function Tab:CreateDropdown(config)
            ...
            local function BuildItems()
                ...
                for _, opt in ipairs(options) do
                    ...
                    item.MouseButton1Click:Connect(function()
                        ...
                        isOpen = false
                        arrow.Text = "â–¾"
                        Tween(container, {Size = UDim2.new(1,0,0,62)})
            ...
            local function OpenClose()
                ...
                if isOpen then
                    Tween(container, {Size = UDim2.new(1,0,0,62 + listH + 6)}, 0.2)
                    Tween(dropFrame,  {Size = UDim2.new(1,-24,0,listH)},         0.2)
                else
                    Tween(container, {Size = UDim2.new(1,0,0,62)},   0.2)
        ...
        -- â”€â”€ Color Picker â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        --[[
        ...
        function Tab:CreateColorPicker(config)
            ...
            swatch.MouseButton1Click:Connect(function()
                isOpen = not isOpen
                if isOpen then
                    Tween(container,    {Size=UDim2.new(1,0,0,54+PICKER_H+10)},0.2)
                    Tween(pickerFrame,  {Size=UDim2.new(1,-24,0,PICKER_H)},    0.2)
                else
                    Tween(container,    {Size=UDim2.new(1,0,0,54)},           0.2)
...
print("ðŸ§± KaolinLib v1.0 loaded! | Mobile:", IsMobile)
return KaolinLib
